...
function About({ nightMode, startTyping }) {
  ...
  const txt = "AWS Certified SDE with 5+ years of experience building scalable, enterprise-grade fintech applications using Python, Java, React, SQL, and AWS, with a strong focus on AI automation. Recently graduated with a Master's in Computer Science from the University of Texas at Arlington specializing in AI, Big Data and Robotics. My thesis comprises of training Vision Transformers like SWIN, Segformer, LaneATT, and LD-CAM using Histogram of Gradients from Event-Based Camera datasets—achieving high sensitivity in road lane detection, significantly outperforming traditional methods. Currently, I work as a Research Assistant at the UTA Research Institute, leveraging event-based cameras and sensor fusion to advance real-time perception and motion tracking for robotics and autonomous systems. I like to build things, solve real-world problems, find the most efficient way to get things done, and channel technology toward making life better for people. Scroll down :)";
