...
const skillsByCategory = {
  ...
  Databases: [
    { icon: <img src="https://upload.wikimedia.org/wikipedia/commons/thumb/2/29/Postgresql_elephant.svg/1200px-Postgresql_elephant.svg.png" alt="PostgreSQL" width={40} height={40} />, name: 'PostgreSQL', isCustom: true, iconUrl: 'https://upload.wikimedia.org/wikipedia/commons/thumb/2/29/Postgresql_elephant.svg/1200px-Postgresql_elephant.svg.png' },
    ...
    { icon: <img src="https://intellyx.com/wp-content/uploads/2023/10/Chroma.png" alt="ChromaDB" width={40} height={40} />, name: 'ChromaDB', isCustom: true, iconUrl: 'https://intellyx.com/wp-content/uploads/2023/10/Chroma.png' },
  ...
  "Artificial Intelligence / Automation": [
    ...
    { icon: <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSKcMdnLnVtxso40OlPI63YHziAlg_34FVbIA&s" alt="Pytorch" width={40} height={40} />, name: 'Pytorch', isCustom: true, iconUrl: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSKcMdnLnVtxso40OlPI63YHziAlg_34FVbIA&s' },
  ...
  "AI Tools": [
    ...
    { icon: <img src="https://ph-files.imgix.net/8d73a492-1c53-4f5d-af1b-6cfa4ead831d.png?auto=format&fit=crop" alt="Bolt.new AI " width={40} height={40} />, name: 'Bolt.new AI ', isCustom: true, iconUrl: 'https://ph-files.imgix.net/8d73a492-1c53-4f5d-af1b-6cfa4ead831d.png?auto=format&fit=crop' },
    { icon: <img src="https://img-cdn.tnwcdn.com/image?fit=1280%2C720&url=https%3A%2F%2Fcdn0.tnwcdn.com%2Fwp-content%2Fblogs.dir%2F1%2Ffiles%2F2024%2F04%2FUntitled-design-49.jpg&signature=55a4b3d80a5145532046130156a0dd55" alt="Mistral AI " width={40} height={40} />, name: 'Mistral AI ', isCustom: true, iconUrl: 'https://img-cdn.tnwcdn.com/image?fit=1280%2C720&url=https%3A%2F%2Fcdn0.tnwcdn.com%2Fwp-content%2Fblogs.dir%2F1%2Ffiles%2F2024%2F04%2FUntitled-design-49.jpg&signature=55a4b3d80a5145532046130156a0dd55' },
    { icon: <img src="https://play-lh.googleusercontent.com/7RIeDBEnjVVn3d1yr441p7u0BK9eT8E6P9i__XYTcJAzOe7sqVgJp7pmlypqY9NBqjI" alt="Manus AI" width={40} height={40} />, name: 'Manus AI', isCustom: true, iconUrl: 'https://play-lh.googleusercontent.com/7RIeDBEnjVVn3d1yr441p7u0BK9eT8E6P9i__XYTcJAzOe7sqVgJp7pmlypqY9NBqjI' },
